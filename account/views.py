    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                return redirect('home:home')
            messages.error(request, 'user or password is wrong', 'warning')
            return render(request, self.template_name, {'form': form})
...
class UserLogoutView(LoginRequiredMixin, View):
    def get(self, request):
        logout(request)
        messages.success(request, 'you logedout succesfully', 'success')
        return redirect('home:home')
...
class UserUnfollowView(LoginRequiredMixin, View):
    def get(self, request, user_id):
        ...
        if relation.exists():
            relation.delete()
            messages.success(request, f'you unfollow {user} successfully', 'success')
        else:
