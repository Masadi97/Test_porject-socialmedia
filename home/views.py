...
class PostDetailView(View):
    ...
    def get(self, request, post_id, post_slug):
        ...
        comment = post.pcomments.filter(is_reply=False)

        return render(request, 'home/detail.html', {'post': post, 'comment': comment, 'form': self.form_class})
...
class PostCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_post.save()
            messages.success(request, 'you create post successfully', 'success')
